...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-action-row', __webpack_require__(4));
    Vue.component('detail-action-row', __webpack_require__(10));
    Vue.component('form-action-row', __webpack_require__(13));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_0_lodash___default()(this.actionFields).each(function (field) {
            field.fill = function () {
                return '';
            };
        });
    ...
    methods: {
        ...
        actionFormData: function actionFormData() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.tap(new FormData(), function (formData) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(_this2.actionFields, function (field) {
                    field.fill(formData);
                });
            });
        },
    ...
    computed: {
        ...
        */
        ...
        actionFields: function actionFields() {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_c("i", { staticClass: "text-lg", class: _vm.field.icon })]
      ),
      _vm._v(" "),
      _c(
        "transition",
